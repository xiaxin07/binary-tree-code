...
public class InorderPrinter extends Printer {
	...
	static {
		int length = 2;
		rightAppend = "┌" + com.mj.printer.Strings.repeat("─", length);
		leftAppend = "└" + com.mj.printer.Strings.repeat("─", length);
		blankAppend = com.mj.printer.Strings.blank(length + 1);
		lineAppend = "│" + com.mj.printer.Strings.blank(length);
	}
	...
	private String printString(
		...
		String nodeString = "";
		if (right != null) {
			rightPrefix += com.mj.printer.Strings.blank(length);
