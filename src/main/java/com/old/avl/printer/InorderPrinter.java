...
public class InorderPrinter extends Printer {
	...
	static {
		int length = 2;
		rightAppend = "┌" + com.old.mj.printer.Strings.repeat("─", length);
		leftAppend = "└" + com.old.mj.printer.Strings.repeat("─", length);
		blankAppend = com.old.mj.printer.Strings.blank(length + 1);
		lineAppend = "│" + com.old.mj.printer.Strings.blank(length);
	}
	...
	private String printString(
		...
		String nodeString = "";
		if (right != null) {
			rightPrefix += com.old.mj.printer.Strings.blank(length);
